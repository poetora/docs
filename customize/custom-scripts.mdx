---
title: '自定义脚本'
description: '通过自定义 CSS 与 JS 深度定制文档'
icon: 'square-function'
---

你可以使用 CSS 为 HTML 元素设定样式，或添加自定义 CSS 与 JavaScript，全面定制文档的外观与交互体验。

## 使用 Tailwind CSS 进行样式设计

使用 Tailwind CSS v4 为 HTML 元素设置样式。你可以控制布局、间距、颜色及其他视觉属性。常见的类包括：
...
Poetora 提供了一组常用的标识符和选择器，帮助你为 UI 中的重要元素添加标签。
