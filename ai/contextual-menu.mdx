...
上下文菜单可快速访问经 AI 优化的内容，以及与主流 AI 工具的直接集成。用户在任意页面打开上下文菜单时，可以将内容复制并作为 AI 工具的 context，或在 ChatGPT、Claude、Perplexity，或你自定义的工具中发起对话，并将你的文档预先加载为 context。
...
<Frame>
  <img src="/images/organize/page-context-menu.png" />
</Frame>
    ...
    "contextual": {
        "options": [
            ...
            "perplexity",
            {
                ...
                "icon": "plus",
                "href": "https://github.com/orgs/poetora/discussions/categories/feature-requests"
            }
        ]
    }
}
